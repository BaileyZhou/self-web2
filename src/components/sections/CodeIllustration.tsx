    ...
    <IllustrationBase
      ...
      chips={
        <FloatingChips
          ...
          chips={[
            { icon: <Code2 size={12} />, label: '代码实践', position: 'top-4', animation: 'animate-float', textColor: 'text-fuchsia-600', gradientFrom: 'from-fuchsia-500', gradientTo: 'to-purple-500' },
            { icon: <Github size={12} />, label: '开源精神', position: 'bottom-10', animation: 'animate-float-delayed', textColor: 'text-purple-600', gradientFrom: 'from-purple-500', gradientTo: 'to-pink-500' },
          ]}
        />
      }
    >
